 ...
 * It covers Firefox browser
 */
public class TestCase_Y_Firefox {
    @Test
    /**
     *-> TestCaseName_Firefox_Test() is used for test the homepage go top function
     */
    public void TestCaseName_Firefox_Test() throws IOException {
        //Try to get this file's parent path
        String parentPath = System.getProperty("user.dir");

        Logger logger = Logger.getLogger(TestCase_Y_Firefox.class);
        ...
        prop.setProperty("log4j.appender.FirefoxTestOutputFile.File", parentPath + ProjectParams.FirefoxTest_Y_LayOut);
        ...
        SimpleLayout FirefoxTest_Y_layout = new SimpleLayout();
        //HTMLLayout htmlLayout = new HTMLLayout();
        FileAppender FirefoxTest_Y_appender = null;
        ...
        try {
            ...
            System.out.println();
            FirefoxTest_Y_appender = new FileAppender(FirefoxTest_Y_layout, parentPath + ProjectParams.FirefoxTest_Y_LayOut, false);
        } catch (Exception e) {
            logger.fatal("the FileAppender cannot be initialized, please check the output path!");
        }


        logger.addAppender(FirefoxTest_Y_appender);
        ...
        //Assert the returns after the user created the topic
        testUtil.waitForTime(1000);
        WebElement ActReturns_CreateTopic = driver.findElement(By.xpath("//*[@id=\"dialog_ask_form_textarea_wrapper\"]/p/span"));
        Assert.assertEquals(ProjectParams.CreateTopicReturns_1, ActReturns_CreateTopic.getText());
