 ...
 * It covers IE browser
 */
public class TestCase_Y_IE {
    @Test
    /**
     *-> TestCaseName_IE_Test() is used for test the homepage go top function
     */
    public void TestCaseName_IE_Test() throws IOException {
        //Try to get this file's parent path
        String parentPath = System.getProperty("user.dir");

        Logger logger = Logger.getLogger(TestCase_Y_IE.class);
        ...
        prop.setProperty("log4j.appender.IETestOutputFile.File", parentPath + ProjectParams.IETest_Y_LayOut);
        ...
        SimpleLayout IETest_Y_layout = new SimpleLayout();
        //HTMLLayout htmlLayout = new HTMLLayout();
        FileAppender IETest_Y_appender = null;
        ...
        try {
            ...
            System.out.println();
            IETest_Y_appender = new FileAppender(IETest_Y_layout, parentPath + ProjectParams.IETest_Y_LayOut, false);
        } catch (Exception e) {
            logger.fatal("the FileAppender cannot be initialized, please check the output path!");
        }


        logger.addAppender(IETest_Y_appender);
